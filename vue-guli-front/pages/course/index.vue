      ...
      <section class="c-sort-box">
        ...
        <div class="mt40">
          ...
          <article class="comm-course-list">
            <ul class="of" id="bna" style="display: grid;grid-template-columns: repeat(4,24%);width: 100%;grid-column-gap: 15px;grid-row-gap: 25px;">
              <li v-for="item in data.items" :key="item.id"
                  style="border: 1px solid #ddd;border-radius: 5px;width: 100%;">
                <div class="cc-l-wrap" style="width: 100%;margin: 0;">
                  ...
                  <div style="font-size: 16px;font-weight: bold;margin-top: 10px;margin-bottom: 10px;">
