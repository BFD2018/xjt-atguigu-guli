    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="课程封面">
        <el-upload
          ...
          <img v-if="courseInfo.cover" :src="courseInfo.cover" class="avatar" style="width: 300px;height: auto;">
    ...
    methods: {
      ...
      getListTeacher() {
        ...
        course.getListTeacher().then(response => {
          ...
          this.teacherList.push(...response.data.teacherList);
        })
      },
      //添加课程
      addCourse() {
