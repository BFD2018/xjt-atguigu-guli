...
import com.xjt.commonutils.utils.ip.AddressUtils;
import com.xjt.commonutils.utils.ip.IpUtils;
import com.xjt.commonutils.utils.uuid.IdUtils;
...
public class TokenService
{
     ...
     * @return 用户信息
     */
    public LoginBody getLoginUser(HttpServletRequest request)
    {
        // 获取请求携带的令牌
        ...
        if (StringUtils.isNotEmpty(token))
        {
            try
            {
                ...
                LoginBody user = redisCache.getCacheObject(userKey);
                return user;
            }
            catch (Exception e)
            {
