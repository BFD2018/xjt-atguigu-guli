...
import com.xjt.eduservice.entity.subject.TwoSubject;
import com.xjt.eduservice.listener.SubjectExcelListener;
import com.xjt.eduservice.mapper.EduSubjectMapper;
...
public class EduSubjectServiceImpl extends ServiceImpl<EduSubjectMapper, EduSubject> implements EduSubjectService {
    ...
    public void saveSubject(MultipartFile file, EduSubjectService subjectService) {
        try {
            ...
            EasyExcel.read(inputStream,EduSubject.class,new SubjectExcelListener(subjectService)).sheet().doRead();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public List<OneSubject> getAllOneTwoSubject() {
        ...
        List<EduSubject> oneSubjectList = baseMapper.selectList(wrapper01);
